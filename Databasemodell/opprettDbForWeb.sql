-- Opprett databasen med tegnsettet utf8mb4_general_ci
CREATE DATABASE IF NOT EXISTS `db_im22son21061` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;

-- Bruk databasen
USE `db_im22son21061`;

-- Opprett tabellen postnummer
CREATE TABLE IF NOT EXISTS `postnummer` (
  `postnummer` VARCHAR(4) NOT NULL,
  `poststed` VARCHAR(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `kunde` (
  ...
  `navn` VARCHAR(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `epost` VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `tlf` VARCHAR(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `nettsted` VARCHAR(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
  `postnummer` VARCHAR(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`kundeID`),
...
-- Opprett tabellen kontaktperson
CREATE TABLE IF NOT EXISTS `kontaktperson` (
  `kontaktpersonID` INT NOT NULL AUTO_INCREMENT,
  `fornavn` VARCHAR(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `etternavn` VARCHAR(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `stilling` VARCHAR(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `avdeling` VARCHAR(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `tlf` VARCHAR(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `epost` VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
-- Opprett tabellen bruker
CREATE TABLE IF NOT EXISTS `bruker` (
  `brukerID` INT NOT NULL AUTO_INCREMENT,
  `brukernavn` VARCHAR(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `passord` VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `erAdministrator` TINYINT NOT NULL,
  PRIMARY KEY (`brukerID`)
) ENGINE = InnoDB DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;

-- Sett inn en prøvebruker
...
INSERT INTO `kunde` (`kundeID`, `navn`, `epost`, `tlf`, `postnummer`) VALUES
