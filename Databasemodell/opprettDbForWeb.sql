...
-- Database for CRM-oppgaven - Gruppe 3
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `db_im22son21061` DEFAULT CHARACTER SET utf8 COLLATE utf8_bin ;
USE `db_im22son21061` ;

-- -----------------------------------------------------
-- Table `db_im22son21061`.`postnummer`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_im22son21061`.`postnummer` (
...
-- -----------------------------------------------------
-- Table `db_im22son21061`.`kunde`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_im22son21061`.`kunde` (
  ...
  CONSTRAINT `fk_kunde_postSted1`
    ...
    REFERENCES `db_im22son21061`.`postnummer` (`postnummer`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `db_im22son21061`.`kontaktperson`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_im22son21061`.`kontaktperson` (
  ...
  CONSTRAINT `fk_kontaktperson_kunde1`
    FOREIGN KEY (`kundeID`)
    REFERENCES `db_im22son21061`.`kunde` (`kundeID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

-- Table `db_im22son21061`.`bruker`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_im22son21061`.`bruker` (
